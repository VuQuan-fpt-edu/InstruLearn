...
class _CourseQnAWidgetState extends State<CourseQnAWidget> {
  ...
  Future<void> _fetchQuestions() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://instrulearnapplication2025-h7hfdte3etdth7av.southeastasia-01.azurewebsites.net/api/QnA/get-all',
        ),
        headers: {
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer $token',
  ...
  Future<void> _submitQuestion() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
          'https://instrulearnapplication2025-h7hfdte3etdth7av.southeastasia-01.azurewebsites.net/api/QnA/create',
        ),
        headers: {
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer $token',
  ...
  Future<void> _submitReply(int questionId) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
          'https://instrulearnapplication2025-h7hfdte3etdth7av.southeastasia-01.azurewebsites.net/api/QnAReplies/create',
        ),
        headers: {
          'Content-Type': 'application/json; charset=UTF-8',
          'Authorization': 'Bearer $token',
